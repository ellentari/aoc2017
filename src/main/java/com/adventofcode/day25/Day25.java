 ...
 * you finally reach the core of the computer. Here, in the expansive central chamber,
 ...
 * It's what makes the whole computer work." You try to explain that Turing machines
 * are merely models of computation, but he cuts you off. "No, see, that's just what
 ...
 * running again would be to create a whole new Turing machine from scratch,
 * but there's no way you can-" He notices the look on your face, gives you a curious glance,
 ...
 * and 1. Based on whether the cursor is pointing at a 0 or a 1, the current state says
 ...
 * checksum would result in the following tape configurations (with the cursor marked in square brackets):
 *
 ...
 * once it does, count the number of times 1 appears on the tape. In the above example,
 ...
 */
class Day25 implements AdventOfCodePuzzle<Long, Integer> {

    private final String blueprint;
    private final int steps;

    Day25(String blueprint, int steps) {
    ...
    public Long solvePartOne() {
        ...
        return turingMachine.getDiagnosticsCheckSum();
    }

    @Override
    public Integer solvePartTwo() {
        throw new UnsupportedOperationException("No part two for day 25!!");
    }
