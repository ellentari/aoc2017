 ...
 */
public class Day7 implements AdventOfCodePuzzle<String, Integer> {
    ...
    public String solvePartOne() {
        Tree tree = treeBuilder.buildFrom(input);
    ...
    public Integer solvePartTwo() {
        ...
        return tree.checkBalance()
                .map(UnbalancedNode::getRequiredWeight)
                .orElse(0);
    }
}
